#map = affine_map<(d0, d1) -> (d0 * 2 + d1 * 3)>
      ...
      scf.for %arg5 = %c0 to %dim_2 step %c1 {
        scf.for %arg6 = %c0 to %c3 step %c1 {
          scf.for %arg7 = %c0 to %c3 step %c1 {
            %13 = affine.apply #map(%arg3, %arg6)
            %14 = affine.apply #map(%arg4, %arg7)
            %15 = memref.load %alloc_3[%arg1, %arg5, %13, %14] : memref<?x?x?x?xf32>
            %16 = memref.load %0[%arg2, %arg5, %arg6, %arg7] : memref<10x2x3x3xf32>
            %17 = memref.load %alloc_9[%arg1, %arg2, %arg3, %arg4] : memref<?x10x?x?xf32>
            %18 = arith.mulf %15, %16 : f32
            %19 = arith.addf %17, %18 : f32
            memref.store %19, %alloc_9[%arg1, %arg2, %arg3, %arg4] : memref<?x10x?x?xf32>
          }
        }
      }
      scf.yield
