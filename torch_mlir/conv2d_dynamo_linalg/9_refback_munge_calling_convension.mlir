module attributes {torch.debug_module_name = "Conv2dWithPaddingDilationStrideModule"} {
  ...
  func.func @forward(%arg0: memref<*xf32>) attributes {llvm.emit_c_interface} {
    ...
    memref.copy %cast, %subview : memref<?x?x?x?xf32> to memref<?x?x?x?xf32, strided<[?, ?, ?, 1], offset: ?>>
    ...
    %cast_20 = memref.cast %alloc_19 : memref<?x10x?x?xf32> to memref<*xf32>
    call @refbackend_consume_func_return_mrf32(%cast_20) : (memref<*xf32>) -> ()
    return
  }
}
